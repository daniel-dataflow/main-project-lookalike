...
wait_for_healthy "namenode-main" 120 5 || on_failure "Hadoop NameNode"

log_service_info "hadoop" "datanode" "Hadoop DataNode 시작" "starting"
docker compose up -d datanode 2>&1 | tee -a "${MAIN_LOG}"
wait_for_healthy "datanode-main" 120 5 || on_failure "Hadoop DataNode"
...
wait_for_healthy "airflow-webserver-main" 600 10 || on_failure "Airflow Webserver"
...
wait_for_healthy "airflow-scheduler-main" 600 10 || on_failure "Airflow Scheduler"
